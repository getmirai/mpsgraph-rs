mod slice_gradient;
mod strided_slice_scalars_or_tensors;

use crate::{Graph, ShapeOrTensor, ShapedType, Tensor};
use objc2::{extern_methods, msg_send, rc::Retained};
use objc2_foundation::{NSArray, NSNumber, NSString};
use slice_gradient::SliceGradientScalarsOrTensors;
use strided_slice_scalars_or_tensors::StridedSliceScalarsOrTensors;
...
impl Graph {
    extern_methods!(
        ...
        #[unsafe(method(sliceUpdateDataTensor:updateTensor:startsTensor:endsTensor:stridesTensor:startMask:endMask:squeezeMask:name:))]
        ...
        /// - name: The name for the operation.
        /// - Returns: A valid MPSGraphTensor object
        #[unsafe(method(sliceUpdateDataTensor:updateTensor:starts:ends:strides:startMask:endMask:squeezeMask:name:))]
        #[unsafe(method_family = none)]
...
impl Graph {
    ...
    pub fn strided_slice_with_masks<'a>(
        &self,
        tensor: &Tensor,
        start_end_stride: StridedSliceScalarsOrTensors<'a>,
        start_mask: u32,
        end_mask: u32,
        squeeze_mask: u32,
        name: Option<&str>,
        ...
        match start_end_stride {
            StridedSliceScalarsOrTensors::Scalars {
                starts,
                ends,
                strides,
            } => {
            ...
            StridedSliceScalarsOrTensors::Tensors {
                start_tensor,
                end_tensor,
                stride_tensor,
            } => unsafe {
    ...
    pub fn slice_gradient_with_masks<'a>(
        ...
        input_gradient_tensor: &Tensor,
        fwd_in_shape_tensor: &Tensor,
        start_end_stride: SliceGradientScalarsOrTensors<'a>,
        start_mask: u32,
        end_mask: u32,
        squeeze_mask: u32,
        name: Option<&str>,
        ...
        match start_end_stride {
            SliceGradientScalarsOrTensors::Scalars {
                starts,
                ends,
                strides,
            } => {
            ...
            SliceGradientScalarsOrTensors::Tensors {
                start_tensor,
                end_tensor,
                stride_tensor,
            } => unsafe {
