...
fn main() {
    ...
    let shaped_type = ShapedType::new(&shape, MPSDataType::Float32);
    ...
    let ranked_type = ShapedType::tensor_type_with_rank(3, MPSDataType::Float16);
    println!("Ranked tensor type: {:?}", ranked_type);

    // Create an unranked tensor type
    let unranked_type = ShapedType::unranked_tensor_type(MPSDataType::Int32);
